...
ObjectStore = (function() {
  ...
  ObjectStore.prototype.do_get = function(transaction) {
    var all_entities, e, entity, ents, found, set, _i, _j, _k, _len, _len1, _len2, _ref,
      _this = this;
    ents = [];
    _ref = transaction.entities;
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    ...
    all_entities = {};
    for (_k = 0, _len2 = ents.length; _k < _len2; _k++) {
      set = ents[_k];
      if (set) {
  ...
  ObjectStore.prototype._lookup = function(spec) {
    var def, end, entity, give, i, id, j, name, property, related, relationship, results, take, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2,
      _this = this;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      id = _ref[_i];
      results[id] = JSON.parse(this._get(this._key(spec, id)));
    }
    if (results.length === 0) {
      return;
    }
    ...
    for (name in _ref2) {
      ...
      if (name in spec) {
        ...
        take.reverse();
        for (_k = 0, _len2 = take.length; _k < _len2; _k++) {
          i = take[_k];
          j = i + 1;
